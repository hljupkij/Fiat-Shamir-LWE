...
#define CRYPTO_SECRETKEYBYTES (BYTES_PRIMENUMBER+ BYTES_HASHPOLYNOMIAL+BYTES_SECRETKEY)
/* Length of public key */
#define CRYPTO_PUBLICKEYBYTES (BYTES_PRIMENUMBER+BYTES_HASHPOLYNOMIAL+BYTES_PUBLICKEY)
